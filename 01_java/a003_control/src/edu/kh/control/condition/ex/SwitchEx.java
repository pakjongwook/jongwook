...
//		} System.out.println(res);
		...
		System.out.println(res);
	} // if -> switch 범위가 정확할때만 , switch -> if 는 바꾸는 거 가능
	...
	public void ex2() {
      ...
      int random = (int)(Math.random()  *3 ); // 0 <= (int) (random *3) < 3.0
       // 0,1,2 중 하나를 무작위 발생
  ...
  // switch 예시 3 : 식의 결과가 "문자열" (String)
	...
	public void ex4() {
		...
		case "/" : 
			...
			System.out.println("0으로는 나눌 수 없습니다");
				...
				System.out.printf("%d %s %d = %3.f",num1,op,num2, (double)num1 / num2);
				break; 
			} 
		case "%" : 
			System.out.printf("%d %s %d = %d",num1,op,num2,num1 % num2);
	...
	public void ex5() {
		...
		case 3 : case 4 : result = "봄"; break;
		
		case 5 : case 6 :  case 7 : case 8 : result = "여름"; break;
