...
public class ConditionEx {
	...
	public void ex4() {
		...
		System.out.println(" 계절이 알고싶은 (달)월을 입력주세요 : ");
		int input = sc.nextInt();
		...
		/*
		 * if - else if - else를 거치게 되면 무조건 result에 값이 하나 저장되어 있다.
		 */
	...
	public void ex6( ) {
		...
		// 나이를 0세 미안 또는 100세 초과 입력시 : "잘못 입력 하셨습니다."
