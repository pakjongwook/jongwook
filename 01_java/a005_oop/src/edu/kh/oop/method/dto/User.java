...
public class User {
	...
	// private : 외부 접근 차단[캡슐화 원칙 적용] (외부에 보지않게)
	...
	// 생성자
	public  User() {} // 기본 생성자  클래스명 같아야함 ex -> User
	
	
	// 매개변수 생성자 (오버로딩 적용) -> 전달받은 매개변수로 필드 초기화
...
//	}
	...
	public String getUserId() {// 이어쓰는 단어의 첫문자는 대문자 카멜표기법
		return userId;
	}
