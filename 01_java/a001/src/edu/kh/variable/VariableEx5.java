...
public class VariableEx5 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 형변환은 왜 필요한가?
		 * -> 컴퓨터의 값 처리원칙을 위배하는 경우를 해결하기위해 필요
		 *  (같은 자료형끼리 연산, 결과도 같은자료형)
		 *  
		 *  [자동 형변환]
	   ...
	   // 연산 결과를 예상해서 저장할 변수의 자료형을 선택 
	    ...
	    // 화면 뒤집힐 경우 -> 인텔HD그래픽 -> 그래픽옵션-> 바로가기키 -> 사용 안함
	    ...
	    System.out.println( (double)65 ); // 65.0 (int -> double)
	    System.out.println( (char)65 );  // int -> char
	    System.out.println( (int) 'B' );// char -> int 
