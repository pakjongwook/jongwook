...
public class BoardTypeInterceptor implements HandlerInterceptor {
	...
	/*
	 * preHandle (전처리) : Dispatcher Servlet -> Controller 사이 postHandle (후처리) :
	 * Controller -> Dispatcher Servlet 사이 afterCompletion (뷰 완성 후): View Resolver
	 * -> Dispatcher Servlet 사이
	 */
