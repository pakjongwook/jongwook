...
<body>
    ...
    <%-- @PathVariable enctype = 
    제출되는 모든 것들을 문자열-> 
    파일도 문자열로 인식해서 오류=> 인코딩을 못하게 막음  --%>
    ...
    -->
        ...
        class="board-write" id="boardUpdateFrm" enctype="multipart/form-data">
            <%--  enctype = multipart/form-data : 제출 데이터 인코딩 X ex) 쓰레기를 버리면 알아서 분리수거
                    -> 파일 제출 가능
            ...
            <h1 class="board-title">
                ...
                placeholder="제목" value="${board.boardTitle}">
            </h1>
