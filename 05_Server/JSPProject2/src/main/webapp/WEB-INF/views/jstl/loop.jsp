...
<body>
        ...
        <h3 style="color:orange"> \${fn:length(리스트명)} : 리스트의 길이 </h3>
        ...
        <h3 style="color:blue">향상된 for문 형식으로 사용하기</h3>

        <ul>

            <c:forEach var="book" items="${bookList}" varStatus="vs">  <!-- items : 컬렉션 요소 -->
                <li>
                    index : ${vs.index} <br>
                    count : ${vs.count} <br>
                    current : ${vs.current} <br>
                    book 과 current는 같음 : ${book} <br>
