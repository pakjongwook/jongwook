...
function getBoxText(){
    ...
    var test1 = document.getElementById("test1"); // 객체
...
function setBoxText(){
    ...
    test1.innerText = "<b>innerText로 <br> 변경된 내용입니다.</b>";  // 태그가 설정되어 있지 않고 글자로 인식
}

// innerHTML로 읽어오기
function getBoxElement(){

    // 문서 내에서 id가 test2인 요소를 얻어와 temp 변수에 저장
