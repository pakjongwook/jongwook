...
btn3.addEventListener("click", ()=>{
    // are1.innerHTML += "<div>"+count1 + "</div>";
    area1.innerHTML += `<div>${count1}</div>`;
                        // {발생하는 변수}
    count1++;
    // 버튼 3 클릭할 때마다 area1 이라는 곳에 숫자를 1씩 늘릴거다.
