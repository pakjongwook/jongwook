...
// let/const 확인  let 부분을 const로 변경 똑같음
let let1 = 10;
...
function typeTest(){
        ...
        // 문서의 id(typeBox)의 요소를 찾아서 상수형 변수의 box에 넣어놔라
        ...
        // 방금 만든 sumFn을 매개변수로 전달

}

function doubleFn(fn){ // 함수 안에 함수 
