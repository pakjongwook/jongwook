...
-- 게시글 좋아요 샘플데이터 삽입
INSERT INTO "BOARD_LIKE" VALUES(1507,4); -- 1507게시글의 4번(마음대로)사용자가 좋아요 
INSERT INTO "BOARD_LIKE" VALUES(1507,3);
COMMIT;
...
SELECT COMMENT_NO, COMMENT_CONTENT, TO_CHAR(C_CREATE_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') C_CREATE_DATE, BOARD_NO, MEMBER_NO, MEMBER_NICKNAME, PROFILE_IMG, PARENT_NO, COMMENT_DEL_FL
FROM "COMMENT"
JOIN MEMBER USING(MEMBER_NO)
WHERE BOARD_NO = 1507
ORDER BY COMMENT_NO;
...
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1', DEFAULT,DEFAULT,1507,8,NULL);

INSERT INTO "COMMENT"									-- 게시글, 회원 
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT,DEFAULT,1507,8,NULL);


-- 자식 댓글 삽입(1507번 부모댓글)
INSERT INTO "COMMENT"                                        --게시글 번호, 댓글 사용자,부모 댓글번호
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 1507, 8,1806);

-- 자식 댓글 (2-1번 1806번)
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 1507, 8, 1806);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 1507, 8, 1806);

-- 자식 댓글 삽입(1807번 부모댓글)
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 1507, 8, 1807);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 1507, 8, 1807);

-- 2-1번자식의 자식 댓글
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식의 자식 댓글', DEFAULT, DEFAULT, 1507, 8,1814);
...
-- 회원 프로필 이미지 변경
UPDATE "MEMBER" SET
PROFILE_IMG = '/resources/images/member/꼬부기.jpg'
WHERE MEMBER_NO = 4;
...
---> 시퀸스 생성 구문을 작성하지 못함 (탈락)
-- INSERT + SUB QUERY

INSERT INTO "BOARD_IMG"
SELECT SEQ_IMG_NO.NEXTVAL, A.*
FROM(SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 0 IMG_ORDER, 1511 BOARD_NO
	FROM DUAL
	
	UNION ALL
	-- 두 SELECT 다 합해라 

	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 1 IMG_ORDER, 1511 BOARD_NO
	FROM DUAL
	
	UNION ALL 

	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 2 IMG_ORDER, 1511 BOARD_NO
	FROM DUAL
