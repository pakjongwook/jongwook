...
boardLike.addEventListener("click", e =>{
    ...
    fetch("/board/like",{
        method : "POST",
        headers : {"Content-Type": "application/json"}, // json : 자바스크립트 '' -> 문자열로 쓰는 것
        body : JSON.stringify(data) // body --> requestBody
    }) //("주소", POST)
    .then(response => response.text()) // {}쓰면 오류 / 응답 객체를 필요한 형태로 파싱하여 리턴
    ...
    .then(count =>{
        ...
        // toggle() : 클래스가 있으면 없애고, 없으면 추가하고 ajax 성공했을때
