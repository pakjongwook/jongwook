...
VALUES(900, '장채현', '901123-2345678', 'jang_ch@kh.or.kr', 
			...
			4300000, 0.2, 200, SYSDATE, NULL, 'N'); -- EMPLOYEE2 의 순서(14) 맞게 넣어 줘야 한다.
...
INSERT INTO EMP_01 -- SELECT 의 결과(24행)를 EMP_01 컬럼에 저장
SELECT EMP_ID, EMP_NAME, DEPT_TITLE
FROM EMPLOYEE2
LEFT JOIN DEPARTMENT2 ON (DEPT_CODE = DEPT_ID);


SELECT * FROM EMP_01; -- EMP_01에 SELECT 결과 24행 저장됨
