...
public class whlieEx {
	...
	public void ex1() {
		...
		int input = -1; // 입력 받은 값을 저장할 변수 , 아무값이 쓴것
	...
	public void ex2() {
		...
		System.out.println("총 가격은" + sum + "원 입니다."); // 괄호 맞추기 
	} 
