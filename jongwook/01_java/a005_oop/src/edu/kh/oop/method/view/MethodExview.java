...
public class MethodExview {
	...
	// 클래스 내 어디서든 사용 가능한 Scanner 객체 사용
	
	
	private MethodExService service = new MethodExService();
	// 클래스 내 어디서든 사용 가능한 MethodExService 객체 사용
	...
	public void displayMenu() {// 메뉴 표시(출력) 기능 
		...
		do {
			...
			System.out.println("2. 매개변수 0, 반환 값 x");
			System.out.println("3. 매개변수 x, 반환 값 o");
			System.out.println("4. 매개변수 0, 반환 값 o");
			...
			case 2 : menu2(); break; // 2 입력시 menu2() 메서드 호출
			case 3 : menu3(); break; // 3 
			case 4 : menu4(); break;
			case 0 : System.out.println("<프로그램 종료>"); break;
			default : System.out.println("잘못 입력 했다. "); 
			}
...
//	3. 매개 변수 x , 반환 값 0
	private void menu3() {
		...
		System.out.println(" 1 부터 10 사이의 난수 5개를 저장한 배열을 반환 받아 출력");
