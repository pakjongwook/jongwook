...
//			String[] menuArr = new String[10];
		...
		// 최고/최저점 인덱스 저장용 변수
			...
			System.out.printf("최고점 : %d (%d학생) \n",max, maxIndex+1);
			System.out.printf("최저점 : %d (%d학생) \n",min, minIndex+1);
		...
		public void ex7() {
			...
			//1) 초기값을 인덱스 범위에 포함되지 않는 값을 작성 (음수)
//			int index = -1; 
//			
