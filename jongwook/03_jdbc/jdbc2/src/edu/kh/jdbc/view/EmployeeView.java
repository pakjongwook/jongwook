...
//	      service.insertEmployee(매개변수 10개); 왠만하면 매개변수 4개까지 권장
	...
	private void retireEmployee() {
		...
		char check = sc.next().toUpperCase().charAt(0); // 문자열 제일 앞 입력 받겠다.
		
		if(check == 'N') {
			System.out.println("[취소되었습니다]");
			return;
		}
		if(check != 'Y') { //  N 도 아니고 Y도 아닌 것
